  ...
  <div>
    ...
    <ul>
      {anecdotes.map(anecdote => (
        <a key={anecdote.id} href={`/anecdotes/${anecdote.id}`}>
...
const CreateNewWihtoutHistory = (props) => {
...
const CreateNew = withRouter(CreateNewWihtoutHistory)
      ...
      <Router>
        <div>
          ...
          <Route exact path="/anecdotes/:id" render={({ match }) =>
            <AnecdoteItem anecdote={anecdoteById(match.params.id)} />
          }/>
